    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(x ->
                        ...
                        x.requestMatchers(HttpMethod.GET, "/api/report/r/**").hasRole("PATIENT") // Sadece GET /api/patient yetkisi                        // Diğer roller için yetkileri belirtelim
                            .requestMatchers("/api/patient/**","/api/report/**").hasAnyRole("ADMIN", "WORKER")
